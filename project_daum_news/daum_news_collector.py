...
from service.sevice_news import get_news
...
for i, item in enumerate(news_category):
    print(f"= {i+1}.{item}")
print("MSG: 수집하고싶은 뉴스 카테고리를 입력해주세요")
...
page = 1 # 시작 페이리 1로 고정
while True:
    url = f"https://news.daum.net/breakingnews/{news_category[news]}={page}"
