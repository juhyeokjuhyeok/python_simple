...
#        abc1(o), 1abc(X)
# 3. 영어 대소문자 구별
#  abc, ABC, Abc, ABc 모두 다른 변수로 인식
# 4. 예약어 사용 불가
# 예약어: Python에서 미리 선점하여 사용중인 키워드
# ex) print, for, while, if, else, class, and, return, inport, def, class ...
...
#           변수      함수        클래스
# JAVA C    camelCase cameCase() PascalCase
# Python    snake_case snake_case() PascalCase


# 9. 동적 출력
print("=" * 200)
student_num = 20233119
student_name = "kimjuhyeok"

# 출력 예: "조선대학교 20233119, kimjuhyeok 입니다"
print("조선대학교 20233119, kimjuhyeok 입니다.") # 하드코딩 지양
# 1. format() - old
