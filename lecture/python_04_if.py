...
#2.6~3.0 : D
#2.5 이하 : F
score = 4.0 # 총학점 0.0~4.5
if  4.1 <= score and score <= 4.5 :
    print("A")
elif 3.6 <= score and score <= 4.0 :
    print("B")
elif 3.1 <= score and score <= 3.5 :
    print("C")
elif 2.6 <= score and score <= 3.0 :
    print("D")
else:
    print("F")
