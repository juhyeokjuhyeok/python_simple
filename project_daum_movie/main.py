...
# ** Selenium 사용방법 2가지
# 1. 직접다운로드
# _ URL: https://sites.google.com/chromium.org/driver/
# 2. 실시간(코드) 다운로드
...
# 6-3. "평점더보기" 클릭 횟수 계산
click_cnt = math.ceil((187 - 10) / 30)

# 7. Seleniu을 통해서 "평점 더보기" 클릭
